...
/*
Questions:
- what happens when you popFront and there are items in middle and/or back?

Solution:
- keep one array as queue, unshift/shift front, math.floor(queue.length/2) splice mid, push/pop back
*/
...
class FrontMiddleBackQueue {
  ...
  popMiddle(): number {
      ...
      const [val] = this.queue.splice(middleIndex, 1)
      return val ?? -1
  }
